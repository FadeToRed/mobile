...
;(function() {
    ...
    function echoCreateSlider(){
        // ── FIX DOPPIO SLIDER: non creare se esiste già ──
    ...
    function echoInitSlider(){
        // ── FIX DOPPIO SLIDER: se esiste già, non fare nulla ──
...
// ── METEO: crea #hxh-bar e lo inserisce in #ff_links con polling ──
;(function() {
    var bar = document.createElement('div');
    bar.id  = 'hxh-bar';
    function insertBar() {
        if (document.getElementById('hxh-meteo-box')) return; // già iniettato
        var ffLinks = document.querySelector('#ff_links');
...
// (WEATHER_BY_CLIMATE, WORLD_TREE, tutte le funzioni meteo, initWidget, updateWidget, hxhStart, stili)
